...
front_rtr = requests.get("http://localhost:8080/function/front",data=roll_no).text
...
if front_rtr == "NO":
    ...
    print(courses_list)
    fetch_rtr = requests.get("http://localhost:8080/function/fetch",data=courses_list).text
